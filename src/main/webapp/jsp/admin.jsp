...
<!--thư viện c-> giúp thực hiện thao tác logic, fmt giúp format   -->
<!DOCTYPE html>
<html lang="en">
	...
	<div class="container-fluid fluid-nav">
		<div class="container cnt-tnar">
			<nav class="navbar navbar-expand-lg navbar-light bg-light tjnav-bar">
				...
				<a href="${pageContext.request.contextPath}/loginSuccess" class="nav-logo"> <img src="resources/img/fast-logo.png">
				</a>
			...
			<div class="search-wrapper" style="margin-top: -5rem;">
				...
				<ul class="nav nav-tabs search-nav-tabs" id="myTab" role="tablist">
					<li class="nav-item search-nav-item"><a class="nav-link"
						href="<c:url value="/?loggedin=admin"/>">TRANG CHỦ</a></li>
					<li class="nav-item search-nav-item"><a class="nav-link"
						href="<c:url value="/job?user=ADMIN&username=${name }"/>">VIỆC LÀM</a></li>
					<li class="nav-item search-nav-item"><a class="nav-link"
						...
						<div class="job-content">
							<div class="job-desc">
								<h2 class="widget-title">
									<span>Việc làm đợi duyệt</span>
								</h2>
							</div>
						</div>

						<c:choose>
							<c:when test="${not empty listJobNotConfirm }">
								<c:forEach var="job" items="${listJobNotConfirm}">
									<div class="job-group">
										<div class="job pagi">
											<div class="job-content">
												<div class="job-logo">
												...
												<div class="job-desc">
													<div class="job-title">
														<a href="<c:url value="/detail?jobID=${job.job_id }&user=ADMIN"/>">${job.title }</a>
													</div>
												...
												<div class="wrap-btn-appl">
													<form action="confirm?jobID=${job.job_id }" method="post">
				...
				<div class="col-md-12 col-sm-12 col-12">
					...
					<div class="job-board-wrap">
						<div class="job-content">
							<div class="job-desc">
								<h2 class="widget-title">
									<span>Việc làm hết hạn tuyển dụng</span>
								</h2>
							</div>
							<div class="wrap-btn-appl">
						...
						<c:choose>
							<c:when test="${not empty listJobExpire }">
								<c:forEach var="job" items="${listJobExpire}">
									<div class="job-group">
										<div class="job pagi">
											<div class="job-content">
												<div class="job-logo">
	...
	<footer class="container-fluid copyright-wrap">
		<div class="container copyright">
			<p class="copyright-content">
				Copyright © 2023 <a href="#"> FindJob</a>. All Right
				Reserved.
			</p>
		</div>
	</footer>
