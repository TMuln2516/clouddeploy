				...
				<div class="w-login m-auto">
					<div class="row">
						...
						<div class="col-md-7 col-sm-12 col-12 login-main-right">
							...
							<form:form class="login-form reg-form" id="form-profile"
								action="profile-manager?username=${username}&userProf=${profile.user_prof}"
								...
								<div class="form-group row">
									<label class="col-sm-3 col-form-label text-right label">Giới tính
									<span style="color: red" class="pl-2">*</span>
									</label>
									<div class="col-sm-9">
										<form:input type="text" id="sex" path="sex" value="${profile.sex }" class="form-control"
											placeholder="Nhập giới tính" onchange="changeSexBorderColor()"/>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-3 col-form-label text-right label">Ngày sinh
									 <span style="color: red" class="pl-2">*</span>
									</label>
									<div class="col-sm-9">
										<form:input type="text" id="dob" path="dob" value="${profile.dob }" class="form-control"
											placeholder="dd/mm/yyyy" onchange=" changeDobBorderColor()"/>
									</div>
								</div>
								<br />
								<input type="submit"
									class="btn btn-primary float-right btn-login d-block w-100"
									value="Lưu hồ sơ" onclick="profile(event)">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 col-12 login-footer-left">
					<div class="login-copyright">
						<p>
							Copyright © 2020 <a href="#"> FindJob</a>. All Rights Reserved.
						</p>
					</div>
				</div>
				<!-- login footer right -->
